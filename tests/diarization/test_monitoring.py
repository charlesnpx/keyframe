...
@pytest.mark.parametrize(
    ...
    (
        ...
        ("engine_config_versions", {"candidateconvtoken": "config-001"}),
        ("engine_config_versions", {"candidateSidRaw": "config-001"}),
        ("engine_config_versions", {"sourceMtgExternal": "config-001"}),
        ("engine_config_versions", {"candidateConvOpaque": "config-001"}),
        ("engine_config_versions", {"monitorSidRaw": "config-001"}),
        ("engine_config_versions", {"candidateSIDRAW": "config-001"}),
        ("engine_config_versions", {"sourceMTGEXTERNAL": "config-001"}),
        ("engine_config_versions", {"candidateCONVOPAQUE": "config-001"}),
        ("engine_config_versions", {"candidate_sidraw": "config-001"}),
        ("engine_config_versions", {"candidateSids": "config-001"}),
        ("engine_config_versions", {"candidateCids": "config-001"}),
        ("engine_config_versions", {"candidateMtgs": "config-001"}),
        ("engine_config_versions", {"candidateConvs": "config-001"}),
        ("engine_config_versions", {"speakerName": "config-001"}),
