...
def recording_from_dict(payload: Mapping[str, Any]) -> CanonicalRecording:
    ...
    return CanonicalRecording(
        ...
        transform_chain_id=_required(data, "transform_chain_id", "recording"),
        sample_rate_hz=_required(data, "sample_rate_hz", "recording"),
        time_basis=_required(data, "time_basis", "recording"),
