"""Presentation-time sampling primitives shared by both video decode passes."""
...
class DecoderTimestampNormalizer:
    """Normalize post-read decoder time and enforce monotonic presentation time."""
    ...
    def __init__(
        ...
        *,
        ...
        self.finite_timestamp_count = 0
        self.leading_unavailable_count = 0
    ...
    def finalize(self) -> None:
        ...
        if (
            self.decoded_frame_count > 1
            and not self._saw_positive_normalized_time
        ):
            raise DecoderTimingUnavailable(
