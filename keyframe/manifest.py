...
def write_manifest(
    ...
    for item in selected:
        ...
        rows.append({
            ...
            "transition_side": item.get("transition_side"),
            "transition_boundary_sample_idx": item.get("transition_boundary_sample_idx"),
            "transition_boundary_timestamp": item.get("transition_boundary_timestamp"),
            "transition_boundary_content_delta": item.get("transition_boundary_content_delta"),
            "transition_boundary_text_band_delta": item.get("transition_boundary_text_band_delta"),
            "transition_boundary_dhash_distance": item.get("transition_boundary_dhash_distance"),
            "transition_boundary_predicates": item.get("transition_boundary_predicates", []),
            "structured_delta_categories": item.get("structured_delta_categories", []),
            "structured_comparator_sample_idx": item.get("structured_comparator_sample_idx"),
            "structured_comparator_timestamp": item.get("structured_comparator_timestamp"),
            "structured_changed_signature_count": item.get("structured_changed_signature_count"),
